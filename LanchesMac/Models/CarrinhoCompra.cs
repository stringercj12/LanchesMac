...
namespace LanchesMac.Models
{
    public class CarrinhoCompra
    {
        ...
        {
            return CarrinhoCompraItems ?? (CarrinhoCompraItems = _context.CarrinhoCompraItens.Where(carrinho => carrinho.CarrinhoCompraId == CarrinhoCompraId).Include(lanche => lanche.Lanche).ToList());
        }
        ...
        public decimal GetCarrinhoCompraTotal()
        {
            var total  = _context.CarrinhoCompraItens
                        ...
                        .Select(carrinho => carrinho.Lanche.Preco * carrinho.Quantidade)
                        .Sum();
